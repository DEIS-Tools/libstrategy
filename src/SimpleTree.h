...
private:
    ...
    struct node_t : std::enable_shared_from_this<node_t>
    {
        ...
        void insert(std::vector<double>& key, json& tree, size_t action, SimpleTree& parent, size_t prefix,
        ...
        bool check_tiles(node_t* start, std::vector<node_ptr>&, std::vector<std::pair<double, double>>& bounds,
                         double val, double minval, double maxval, bool minimization, size_t offset);
        bool subsumes(const std::vector<std::pair<double, double>>& bounds,
                      std::vector<std::pair<double, double>>& obounds, double val, bool minimization, size_t offset,
                      double& best, std::pair<double, double>& closest) const;
        ...
        {  ///< support implicit conversion for map keys
            if (is_leaf())
